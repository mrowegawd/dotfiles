...
if !has('nvim')
  ...
  nnoremap <silent> <A-S-l> :execute "vertical resize +5"<Return>
  nnoremap <silent> <A-S-j> :execute "vertical resize -5"<Return>
...
if !has('nvim')
  ...
  " Toggle netrw
  noremap <silent> <F1> :call ToggleNetrw()<CR>
  ...
  nnoremap <leader><F1> :FindNetrwc<space>
end
" }}}
" commandline ---------------- {{{
"
