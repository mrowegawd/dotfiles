...
local def_map = {
    ...
    ["n|gh"] = map_cu("bp"):with_noremap():with_silent(),
    ["n|gl"] = map_cu("bn"):with_noremap():with_silent(),
    ...
    ["n|<C-q>"] = map_cr("wq"),
    ["n|<TAB>"] = map_cr('lua require("internal.util").fold_toggle()'):with_noremap():with_silent(),
    ["n|<S-TAB>"] = map_cr('lua require("internal.util").fold_toggle("a")'):with_noremap():with_silent(),
    ...
    ["n|<Leader>ob"] = map_cr([[lua require("internal.util").handleURL(true)]]):with_noremap():with_silent(),
    ["v|<Leader>ob"] = map_cr([[lua require("internal.util").handleURL(false)]]):with_noremap():with_silent(),
    ["n|<Leader>q"] = map_cr('lua require("internal.util").copenloc_toggle("c")'):with_noremap():with_silent(),
    ["n|<Leader>Q"] = map_cr('lua require("internal.util").copenloc_toggle("l")'):with_noremap():with_silent(),
