...
local def_map = {
    ...
    ["n|<C-q>"] = map_cr("wq"),
    ["n|<TAB>"] = map_cr('lua require("core.configs").fold_toggle()'):with_noremap():with_silent(),
    ["n|<S-TAB>"] = map_cr('lua require("core.configs").fold_toggle("a")'):with_noremap():with_silent(),
