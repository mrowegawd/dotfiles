...
--   ["v|<c-f>"]           = map_cmd('<Esc>/\\%V'):with_noremap(),
  ...
  ["n|<C-q>"]           = map_cr('wq'),
  ["n|1"]               = map_cr('lua require("core.configs").fold_toggle()'):with_noremap():with_silent(),
  ...
  ["n|<Leader>ob"]      = map_cr('lua require("core.configs").handleURL()'):with_noremap():with_silent(),
  ["v|<Leader>ob"]      = map_cr('lua require("core.configs").handleURL()'):with_noremap():with_silent(),
