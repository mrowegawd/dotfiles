...
--     ["n|<C-s>"]      = map_cu('write'):with_noremap(),
    ...
    ["n|<Leader><TAB>"] = map_cmd(':q<CR>'):with_noremap(),
...
--     ["n|<A-]>"]      = map_cr('vertical resize +5'):with_silent(),
    ...
    ["n|<Leader>n"]     = map_cmd(':nohl<CR>'),
    ["n|<Leader>p"]     = map_cmd(":echo expand('%')<CR>"):with_noremap(),
    ["n|<Leader>cd"]    = map_cmd(":cd %:p:h<cr>"):with_noremap(),
