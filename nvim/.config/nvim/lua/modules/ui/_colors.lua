...
colors.custom_hi = function()
    ...
    hi(
        string.format(
            "hi DiffAdd ctermbg=235 ctermfg=108 cterm=reverse guibg=%s guifg=%s gui=reverse",
            colors.nm.bg,
            colors.nm.green
        )
    )
    hi(
        string.format(
            "hi DiffChange ctermbg=235 ctermfg=103 cterm=reverse guibg=%s guifg=%s gui=reverse",
            colors.nm.bg,
            colors.nm.yellow
        )
    )
    hi(
        string.format(
            "hi DiffDelete ctermbg=235 ctermfg=131 cterm=reverse guibg=%s guifg=%s gui=reverse",
            colors.nm.bg,
            colors.nm.red
        )
    )
    hi(
        string.format(
            "hi DiffText ctermbg=235 ctermfg=208 cterm=reverse guibg=%s guifg=%s gui=reverse",
            colors.nm.bg,
            colors.nm.blue
        )
    )
