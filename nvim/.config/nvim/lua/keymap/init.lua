...
local plug_map = {
  ...
  ["n|<Leader>fw"]     = map_cu('<cmd>lua require("telescope._custom").grep_prompt()'):with_noremap():with_silent(),
  --     ["n|<Leader>fw"]     = map_cu('Telescope grep_prompt'):with_noremap():with_silent(),
  ["n|<Leader>fW"]     = map_cu('<cmd>lua require("telescope._custom").grep_prompt_word()<CR>'):with_noremap():with_silent(),
