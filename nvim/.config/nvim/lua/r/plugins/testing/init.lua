            ...
            require("legendary").keymaps {
                {
                    ...
                    keymaps = {
                        ...
                        },
                        {
                            ...
                            description = "Neotest: nearest with debug",
                        },
                        ...
                        },
                        {
                            ...
                            description = "Neotest: run last with debug",
                        },

                        {
                            ...
                            description = "Neotest: test file with debug",
                        },
...

                        {
                            ...
                            description = "Neotest: preview the output",
                        },
                        {
                            "<Localleader>to",
                            '<CMD>lua require("neotest").summary.toggle()<CR>',
                            description = "Neotest: summary",
                        },
