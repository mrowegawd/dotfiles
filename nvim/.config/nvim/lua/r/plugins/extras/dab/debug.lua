...
return {
  ...
  -- NVIM-DAP-UI
  {
    ...
    -- stylua: ignore
    keys = {
      { "<Leader>dt", "", desc = "+DebugToggle" },
      { "<Leader>dtu", function() require("dapui").toggle() end, desc = "Debug: toggle UI [dapui]" },
      { "<Leader>dtr", function() return require("dapui").open { reset = true } end, desc = "Debug: reset layout UI [dapui]" },
