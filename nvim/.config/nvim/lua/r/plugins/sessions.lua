        ...
        keys = {
            {
                ...
                desc = "Session(persistence): restore Session",
            },
            {
                "<leader>ql",
                function()
                ...
                desc = "Session(persistence): restore last session",
            },
            {
                "<leader>qS",
                function()
                ...
                desc = "Session(persistence): don't save current session",
            },
        },
    },
    -- NVIM-POSSESSION
        ...
        keys = {
            {
                ...
                desc = "Session(projects): open project lists",
            },
        },
