...
M.static = {
    click_args = function(self, minwid, clicks, button, mods)
        ...
        local sign = vim.fn.screenstring(
    ...
    self.handlers.fold = function(args)
        ...
        vim.cmd.execute(
            "'"
                .. lnum
                .. "fold"
                .. (vim.fn.foldclosed(lnum) == -1 and "close" or "open")
                .. "'"
        )
    end
end
...
M.signs = {
    ...
    init = function(self)
        ...
        signs = vim.tbl_filter(function(sign)
            return not vim.startswith(sign.group, "oc")
        end, signs[1].signs)
...
M.folds = {
    ...
    init = function(self)
        ...
        self.folded = vim.fn.foldlevel(self.lnum)
            > vim.fn.foldlevel(self.lnum - 1)
    end,
    {
...
M.git_signs = {
    ...
    --     init = function(self)
    --         local signs =
    --             vim.fn.sign_getplaced(vim.api.nvim_get_current_buf(), {
