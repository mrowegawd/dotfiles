      ...
      return {
        ...
        mappings = {
          discussion = {
            ...
            next_comment = { lhs = "]c", desc = "go to next comment [discussion]" },
            prev_comment = { lhs = "[c", desc = "go to previous comment [discussion]" },
          ...
          issue = {
            ...
            open_in_browser = { lhs = "<space>go", desc = "open issue in browser [issue]" },
            ...
            -- next_comment = { lhs = "", desc = "go to next comment [issue]"},
            -- prev_comment = { lhs = "", desc = "go to previous comment [issue]"},
          ...
          pull_request = {
            ...
            open_in_browser = { lhs = "<space>go", desc = "open PR in browser [pull request]" },
