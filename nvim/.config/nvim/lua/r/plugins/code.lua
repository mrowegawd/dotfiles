...
return {
  ...
  -- MULTICURSOR
  {
      ...
      return {
        {
          ...
          desc = "Misc: cursor above [multicursor]",
        },
        {
          "<Down>",
          function()
          ...
          desc = "Misc: cursor down [multicursor]",
        },
        {
          "<Esc>",
          function()
          ...
          desc = "Misc: exit from multicursor [multicursor]",
        },
        {
          "<a-d>",
          function()
          ...
          desc = "Misc: add cursor [multicursor]",
        },
        {
          "<a-s>",
          function()
          ...
          desc = "Misc: jump next word under cursor but not add a cursor [multicursor]",
        },
        {
          "<c-leftmouse>",
          function()
    ...
    config = function()
      ...
      Highlight.plugin("multicursorAu", {
        { MultiCursorCursor = { fg = { from = "CmpItemAbbr", attr = "fg" } } },
        { MultiCursorVisual = { fg = { from = "CmpItemAbbr", attr = "fg" } } },
      })
