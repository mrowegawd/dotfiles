...
-- Constants
local RULES_DIR = vim.fs.normalize(vim.fs.joinpath(vim.env.HOME, "git-repos", "private", "ai-harness", "rules"))
...
local function repo_rule_file(path)
  return repo_helpers.git_root_file("AGENTS.md", path) or repo_helpers.git_root_file("CLAUDE.md", path)
end
