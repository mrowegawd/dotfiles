...
if vim.g.colorscheme == "ef-eagle" then
  branch_fg = Highlight.tint(Highlight.get("GitSignsAdd", "fg"), 1)
  filepath = Highlight.tint(Highlight.get("StatusLine", "fg"), 0.6)
  filepath_winbar_active_fg = Highlight.tint(Highlight.get("LineNr", "fg"), -0.5)
  ...
  normal_fg_white = Highlight.tint(Highlight.get("StatusLine", "fg"), 1)
end

if vim.g.colorscheme == "rose-pine-dawn" then
  branch_fg = Highlight.tint(Highlight.get("GitSignsAdd", "fg"), 1)
  filepath = Highlight.tint(Highlight.get("LineNr", "fg"), 0.3)
  filepath_winbar_active_fg = Highlight.tint(Highlight.get("LineNr", "fg"), -0.5)
  filepath_winbar_active_fg_filename = Highlight.tint(Highlight.get("LineNr", "fg"), -0.5)
  filepath_winbar_fg = Highlight.tint(Highlight.get("LineNr", "fg"), -0.05)
  session = Highlight.tint(Highlight.get("DiagnosticSignWarn", "fg"), 0.2)
...
if vim.g.colorscheme == "sunburn" then
  fg = Highlight.tint(Highlight.get("StatusLine", "fg"), 0.25)
...
if vim.g.colorscheme == "coffeecat" then
  filepath = Highlight.tint(Highlight.get("StatusLine", "fg"), 0.8)
end
...
if vim.g.colorscheme == "zenburned" then
  ...
  filepath_winbar_active_fg = Highlight.tint(Highlight.get("LineNr", "fg"), 0.6)
end
