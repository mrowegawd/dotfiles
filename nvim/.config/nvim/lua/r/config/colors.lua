...
local general_overrides = function()
  Highlight.all {
    ...
    -- WINBAR
    { WinbarFilepath = { fg = { from = "LineNr", attr = "fg", alter = 1.1 } } },
    ...
    {
      SnacksNotifierInfo = {
        fg = { from = "diffAdd", attr = "fg", alter = 1 },
        bg = { from = "diffAdd", attr = "fg", alter = -0.5 },
      },
    },
    {
    ...
    {
      SnacksNotifierError = {
        fg = { from = "diffDelete", attr = "fg", alter = 1 },
        bg = { from = "diffDelete", attr = "fg", alter = -0.5 },
      },
    },
    {
    ...
    -- WARN
    {
      SnacksNotifierWarn = {
        ...
        bg = { from = "diffChange", attr = "fg", alter = -0.5 },
      },
    },
    {
...
local function colorscheme_overrides()
  local overrides = {
    ...
    ["base46-seoul256_dark"] = {
      ...
      { FzfLuaHeaderText = { fg = { from = "FzfLuaBorder", attr = "fg", alter = 0.35 } } },
      {
        TelescopeResultsNormal = {
          fg = { from = "FzfLuaFilePart", attr = "fg" },
          bg = { from = "FzfLuaNormal", attr = "bg" },
