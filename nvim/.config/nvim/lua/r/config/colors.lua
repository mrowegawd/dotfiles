...
local general_overrides = function()
  ...
  H.all {
    ...
    {
      StatusLine = {
        fg = { from = "Normal", attr = "fg", alter = colors.statusline_fg_alter },
        bg = { from = "Normal", attr = "bg", alter = colors.statusline_bg_alter },
        reverse = false,
      },
    },
    ...
    {
      FzfLuaTitle = { fg = { from = "FzfLuaSel", attr = "fg", alter = 0.1 }, bg = "NONE", reverse = false, bold = true },
    },
  ...
  H.all {
    ...
    { QuickFixFileName = { fg = { from = "Directory", attr = "fg" }, bg = "NONE" } },
    {
      QuickFixLine = {
        ...
        bg = "NONE",
        sp = { from = "QuickFixFileName", attr = "fg", alter = colors.quickfixline_sp_alter },
        underline = true,
        bold = true,
        reverse = false,
      },
