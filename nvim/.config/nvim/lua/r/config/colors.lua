...
local general_overrides = function()
  ...
  H.all {
    ...
    {
      LspCodeLens = {
        fg = { from = "LineNr", attr = "fg", alter = colors.lsp_code_lens_fg_alter },
        bg = { from = "LineNr", attr = "fg", alter = colors.lsp_code_lens_bg_alter },
      },
    },
