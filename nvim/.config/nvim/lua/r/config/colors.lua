local base_cl = {
  ...
  fzflua_cursorline_bg_alter = 0.4,
  ...
  quickfixline_header_fg_alter = 1.2,
...
reset_base_alter({ "base46-kanagawa" }, {
  ...
  fzflua_cursorline_bg_alter = 0.55,
  fzflua_file_part_fg = -0.17,
  linenr_fg_alter = 0.2,
...
reset_base_alter({ "base46-oxocarbon" }, {
  ...
  fzflua_cursorline_bg_alter = 0.95,
  fzflua_file_part_fg = -0.17,
  linenr_fg_alter = 0.3,
...
reset_base_alter({ "lackluster" }, {
  ...
  fzflua_cursorline_bg_alter = 1.8,
...
reset_base_alter({ "neogotham" }, {
  ...
  fzflua_cursorline_bg_alter = 1.95,
  fzflua_headertext_fg_alter = -0.2,
  linenr_fg_alter = 0.15,
  noice_cmdline_fg_alter = 0.6,
  nontext_fg_alter = 4,
