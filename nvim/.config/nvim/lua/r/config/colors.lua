...
local update_col_colorscheme = {
  ...
  ["lackluster"] = {
    ...
    normal_keyword_alter = 0.1,
    pmenu_bg_alter = 2.2,
    quickfixline_linenr_fg_alter = 1.4,
