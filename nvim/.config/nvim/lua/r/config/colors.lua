...
local update_col_colorscheme = {
  ...
  ["rose-pine"] = {
    ...
    zshlines_fg_alter = 1.6,
    zshlines_bg_alter = 4.5,
  },
  ["rose-pine-moon"] = {
  ...
  ["vscode"] = {
    ...
    grugfar_result_linenr_fg_alter = 0.7,
    linenr_fg_alter = 1.6,
    lsp_code_lens_bg_alter = 1.8,
    lsp_code_lens_fg_alter = 9.5,
  ...
  H.all {
...

    {
      GrugFarResultsMatch = {
        ...
        bg = { from = "Function", attr = "fg", alter = -0.5 },
        bold = true,
      },
    },
    {
