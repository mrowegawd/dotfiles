  ...
  local overrides = {
    ...
    ["base46-catppuccin"] = {
...

      {
        Folded = {
          ...
          bg = { from = "Keyword", attr = "fg", alter = -0.78 },
        },
      },
      { FoldedSign = { fg = { from = "Folded", attr = "fg", alter = -0.4 }, bg = "NONE" } },
    ...
    ["base46-kanagawa"] = {
      ...
      },
      {
        TabLine = {
          fg = { from = "Normal", attr = "bg", alter = 1.6 },
          bg = { from = "Normal", attr = "bg", alter = 0.43 },
        },
      },
    ...
    ["lackluster"] = {
      ...
      },
      {
        TabLine = {
          ...
          bg = { from = "Normal", attr = "bg", alter = 1.15 },
        },
      },
    ...
    ["tokyonight-storm"] = {
      ...
      { KeywordBlur = { bg = { from = "StatusLineNC", attr = "bg", alter = 0.2 } } },
      {
        TabLine = {
          fg = { from = "Normal", attr = "bg", alter = 1.5 },
          bg = { from = "Normal", attr = "bg", alter = 0.42 },
        },
      },
    ...
    ["vinyl"] = {
      ...
      {
        LspReferenceWrite = {
          bg = { from = "LspReferenceWrite", attr = "bg", alter = -0.45 },
          underline = false,
          reverse = false,
          undercurl = false,
        },
      ...
      {
        LspReferenceRead = {
          bg = { from = "LspReferenceRead", attr = "bg", alter = -0.6 },
          underline = false,
          reverse = false,
          undercurl = false,
        },
