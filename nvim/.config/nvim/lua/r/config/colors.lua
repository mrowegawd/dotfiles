...
local general_overrides = function()
  ...
  H.all {
    ...
    {
      TabLine = {
        fg = { from = "StatusLine", attr = "bg", alter = colors.tabline_fg_alter },
        bg = { from = "StatusLine", attr = "bg" },
        reverse = false,
      },
    },
    ...
    { FzfLuaCursorLine = { bg = { from = "FzfLuaBorder", attr = "fg", alter = 0.1 } } },
...
local function set_panel_highlight()
  ...
  H.all {
    ...
    {
      QuickFixLine = {
        -- fg = { from = "QuickFixFileName", attr = "fg", alter = colors.quickfixline_fg },
        fg = "NONE",
        bg = "NONE",
