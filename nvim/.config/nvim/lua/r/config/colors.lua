    ...
    ["base46-zenburn"] = {
      {
        Folded = {
          inherit = "Folded",
          fg = { from = "Folded", attr = "fg", alter = -0.25 },
          bg = { from = "Folded", attr = "bg", alter = -0.32 },
        },
      },
      { FoldedSign = { fg = { from = "Folded", attr = "fg", alter = -0.4 }, bg = "NONE" } },
