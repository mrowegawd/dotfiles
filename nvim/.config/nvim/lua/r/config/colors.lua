  ...
  local overrides = {
    ...
    ["base46-onenord"] = {
      ...
      -- STATUSLINE
      {
        StatusLine = {
          fg = Highlight.tint(
            Highlight.darken(Highlight.get("Normal", "bg"), 0.5, Highlight.get("Normal", "bg")),
            0.95
          ),
          bg = Highlight.tint(Highlight.darken(Highlight.get("Normal", "bg"), 0.5, Highlight.get("Normal", "bg")), 0.2),
          reverse = false,
    ...
    ["kanso"] = {
      -- { LineNr = { fg = { from = "Normal", attr = "bg", alter = 4 }, bold = true } },
      -- { LineNrAbove = { link = "LineNr" } },
      -- { LineNrBelow = { link = "LineNr" } },
...

      {
        Folded = {
          ...
          bg = Highlight.tint(
            Highlight.darken(Highlight.get("Keyword", "fg"), 0.23, Highlight.get("Normal", "bg")),
            -0.3
          ),
        },
      },
      ...
      {
        FloatBoxComment = {
          fg = { from = "NormalBoxComment", attr = "bg", alter = 0.6 },
          bg = { from = "NormalBoxComment", attr = "bg" },
        },
      },
      {
