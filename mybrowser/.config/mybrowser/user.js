...
// IMPORTANT !! comment out the network.http.referer.network.http.referer.XOriginPolicy
user_pref("network.http.referer.XOriginTrimmingPolicy", 2);
// IMPORTANT !! comment out the network.http.referer.XOriginTrimmingPolicy

user_pref("extensions.blocklist.url", "https://blocklists.settings.services.mozilla.com/v1/blocklist/3/%20/%20/");
// IMPORTANT !! comment out the extensions.blocklist.url above

// other

// IMPORTANT !! comment out the browser.search.update above
user_pref("browser.search.update", true);

// IMPORTANT !! comment out the keyword.enabled
user_pref("keyword.enabled", true);

user_pref("signon.rememberSignons", false);

// IMPORTANT !! comment out the privacy.resistFingerprinting.letterboxing
